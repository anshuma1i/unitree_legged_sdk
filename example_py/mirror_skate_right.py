#!/usr/bin/python
# mirror_skate_right.py
# Smoothly ramp into lie_skate_right.npy pose and hold indefinitely
...
def main():
    if not os.path.exists("lie_skate_right.npy"):
        print("✗ lie_skate_right.npy not found. Run record_skate_right.py first.")
        return
    target_pose = np.load("lie_skate_right.npy")
    ...
    print("► Ramping smoothly into lie_skate_right pose...")
