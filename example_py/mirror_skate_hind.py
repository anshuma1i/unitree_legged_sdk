#!/usr/bin/python
# mirror_skate_hind.py
# Smoothly ramp into lie_skate_hind.npy pose and hold indefinitely
...
def main():
    if not os.path.exists("lie_skate_hind.npy"):
        print("✗ lie_skate_hind.npy not found. Run record_skate_hind.py first.")
        return
    target_pose = np.load("lie_skate_hind.npy")
    ...
    print("► Ramping smoothly into lie_skate_hind pose...")
    ...
    try:
        while True:
            ...
            safe.PowerProtect(cmd, state, 0)  # relaxed safety
